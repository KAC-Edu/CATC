...
loadFile: function(e) {
    ...
    resetQuizFont: function() {
        try { localStorage.setItem('kacQuizFontScale', JSON.stringify({ q: 1, opt: 1 })); } catch (e) {}
