...
refs.shuttleReq.on('value', s => {
    ...
    // [J45] 자차 디폴트(J42~J44) 원복 — 화면마다 카운트가 달라 혼선. 모든 셔틀 화면을 '실제 신청자만'으로 통일.
