        ...
        if(bdEl){
            ...
            if(sortedQ.length === 0){
                ...
                bdEl.innerHTML = sortedQ.map((s,ri)=>{
                    ...
                    return `<div class="qbd-row${worst?' qbd-worst':''}">
                        <div class="qbd-top">
