...
loadCurrentSettings: function() {
    firebase.database().ref(`courses/${state.room}`).once('value', snap => {
        ...
        Array.from(roomSelect.options).forEach(opt => {
            ...
            if (this.occupiedLocations.includes(this._normVenue(opt.value))) {
