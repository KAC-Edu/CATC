...
ui.openScheduleView = function(){
  ...
  // [J27 핵심] 클릭 제스처가 살아있는 지금 즉시 모니터 전체화면 진입 (이미 전체화면이면 그대로)
  ui._scheduleEnteredFs = false;
  if(!(document.fullscreenElement || document.webkitFullscreenElement)){
    try{
