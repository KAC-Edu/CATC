    ...
    openOtpFullscreen: function() {
        ...
        ov.innerHTML =
            ...
            +   (_guideSrc
                 ...
                 +   '<img src="'+_guideSrc+'" alt="OTP 출결 안내" style="max-width:100%; max-height:100%; width:auto; height:auto; object-fit:contain; border-radius:14px; border:1px solid rgba(255,255,255,.14); box-shadow:0 8px 28px rgba(0,0,0,.4); background:#fff;">'
                 + '</div>'
